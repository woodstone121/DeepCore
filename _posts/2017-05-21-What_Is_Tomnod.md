...
During labelling campaigns, the user is given a satellite image with an area outlined and are asked to choose from a short list what the marked area is best labelled as. ![Tomnod Classification]({{ site.baseurl }}/assets/images/what_is_tomnod/validation.png){: width="100%"}
